...
class TestConfig:
    ...
    def test_default_config(self):
        ...
        assert config.cache_file == "cache/aws_data_cache.json"
...
class TestArgumentParsing:
    ...
    def test_default_arguments(self):
        ...
        with patch("sys.argv", ["main.py"]):
            ...
            assert args.cache_file == "cache/aws_data_cache.json"
    ...
    def test_numeric_argument_validation(self):
        ...
        with patch(
            "sys.argv", ["main.py", "--max-workers", "20", "--cache-hours", "72"]
        ):
            args = parse_arguments()
...
class TestEdgeCases:
    ...
    def test_boundary_values(self):
        ...
        # Large values
        with patch(
            "sys.argv", ["main.py", "--max-workers", "100", "--cache-hours", "8760"]
        ):
            args = parse_arguments()
